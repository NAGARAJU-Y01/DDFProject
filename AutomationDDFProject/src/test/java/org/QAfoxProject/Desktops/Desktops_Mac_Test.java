...
public class Desktops_Mac_Test extends BaseConfiguration {
	...
	public void addProduct_Desktops_Mac() {
		...
		test.log(Status.PASS, "Step 4: Mac_Text Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5: iMac_hypertext Element Verified Successfully");
		
		//Perform the Click Action--iMac_Hyperlink
		mac1obj.getImac_hypertext().click();
		test.log(Status.PASS, "Step 5.1: iMac_hypertext Element Clicked Successfully");
		...
		test.log(Status.PASS, "Step 5.2: iMac_textfield Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5.3: Brand_nametext Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5.4: Product_Code_Text Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5.5: Avaliability_text Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5.6: Product_Price_text Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5.7: Excisetax_Price_text Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5.8: Qty_Header_text Element Verified Successfully");
		...
		test.log(Status.PASS, "Step 5.9: Qty_textfield Element Verified Successfully");
		
		//Perform the Click Action--Qty_textfield
		macobj.getQty_textfield().click();
		test.log(Status.INFO, "Step 5.10: Qty_textfield Element Clicked Successfully");
		macobj.getQty_textfield().clear();
		test.log(Status.INFO, "Step 5.11: Qty_textfield Element Cleared Successfully");
		macobj.getQty_textfield().sendKeys("2");
		test.log(Status.INFO, "Step 5.12: In Qty_textfield Element, Qty Entered Successfully");
		...
		test.log(Status.PASS, "Step 6: Add to Cart Button Element Verified Successfully");
		
		//Perform the Click Action--Add to Cart button
		macobj.getAddtocartbutton().click();
		test.log(Status.INFO, "Step 6.1: Add to Cart Button Element Clicked Successfully");
		...
		test.log(Status.PASS, "Step 7: Shoppingcart Button Element Verified Successfully");
						
		//Perform the Click Action--Shopping Cart
		javalibraryobj.pause(4000);
		macobj.getCartbutton().click();
		test.log(Status.INFO, "Step 7.1: Shopping Cart Button Element Clicked Successfully");
		...
		test.log(Status.PASS, "Step 8: View Cart Button Element Verified Successfully");
		
		//Perform the Click Action--View Cart Hyperlink
		macobj.getView_cart_hypertext().click();
		test.log(Status.INFO, "Step 8.1: View Cart Hyperlink Element Clicked Successfully");
		...
		test.log(Status.PASS, "Step 9: Checkout Button Element Verified Successfully");
		
		//Perform the Click Action--Checkout
		macfinalobj.getCheckoutbutton().click();
		test.log(Status.INFO, "Step 9.1: Checkout Button Element Clicked Successfully");
		...
		//Perform the Click Action--CartButton
		macobj.getCartbutton().click();
		test.log(Status.INFO, "Step 9.1: Cart Button Element Clicked Successfully");
		//Perform the Click Action--ClearAllItems in the ShoopingCart
		macobj.getCartitemsclearbutton().click();
		test.log(Status.INFO, "Step 9.1: Cart Items Elements Cleared Successfully");
		
		//Perform the Click Action--Continue Button
		macfinalobj.getContinuebutton().click();
		test.log(Status.INFO, "Step 10: Continue Button Element Clicked Successfully");
		//Navigate back to the Home Page
		//webdriverobj.driver.navigate().to("https://tutorialsninja.com/demo/");
		
		test.log(Status.INFO, "Step 11: Desktops_Mac_Product Added to Cart and Checkout Performed Successfully");
	...
	public void m1() {
		...
		//Click on the Tablets Module
		homeobj.getTabletsheaderlink().click();
		test.log(Status.INFO, "Step-1: Tablets Module Headerlink Element Clicked Successfully");
	}
